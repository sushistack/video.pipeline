...
class AudioState(rx.State):
    ...
    def load_projects(self):
        ...
        output_root = PARENT_DIR / "outputs"
    ...
    async def start_generation(self):
        ...
        try:
            ...
            # Init Adapter
            adapter = GPTSoVITSAdapter(base_dir=PARENT_DIR)
            ...
            input_root = PARENT_DIR / "materials/audios/inputs"
            all_voice_files = []
            ...
            for lang_code, sc_path, matches in scenarios:
                ...
                for idx, (voice_name, text) in enumerate(matches):
                    ...
                    try:
                        ...
                        async for log_line in adapter.async_generate_voice(
...
class ScenarioState(rx.State):
    ...
    def _detect_speakers(self):
        ...
        srt_path = PARENT_DIR / "outputs" / self.selected_project / "subtitles" / "ja.srt"
    ...
    def on_load(self):
        ...
        audio_inputs = PARENT_DIR / "materials" / "audios" / "inputs"
...
class SubtitleState(rx.State):
    ...
    def _load_resources(self):
        ...
        proj_root = PARENT_DIR / "outputs" / self.selected_project
