...
class ExtractState(rx.State):
    ...
    def load_files(self):
        ...
        video_input_dir = PARENT_DIR / "materials" / "videos"
    ...
    async def start_extraction(self):
        ...
        try:
            ...
            # Get file path
            audio_path = PARENT_DIR / "materials" / "videos" / self.selected_file
            ...
            if self.should_stop:
                ...
                self.log(f"📁 Output saved to: outputs/{audio_path.stem}/subtitles/")
                self.log("=" * 50)
