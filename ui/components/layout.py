    ...
    return rx.box(
        rx.hstack(
            ...
            rx.hstack(
                ...
                nav_link("🎨 Prompter", "/image-prompter"),
                nav_link("🖼️ Preprocess", "/image-preprocess"),
                nav_link("🎬 Scene", "/scene-detect"),
                spacing="6",
                position="absolute",
                left="50%",
            ...
            rx.vstack(
                ...
                rx.grid(
                    ...
                    rx.vstack(
                        ...
                        footer_link("Prompter", "/image-prompter"),
                        footer_link("Image Preprocess", "/image-preprocess"),
                        footer_link("Scene Detect", "/scene-detect"),
                        align_items="start",
                        spacing="2",
                    ),
                    ...
                    rx.vstack(
                        ...
                        rx.hstack(
                             ...
                             rx.badge("Qwen3-TTS", color_scheme="blue", variant="soft", size="2"),
                             spacing="2",
                        ),
