                ...
                rx.vstack(
                    ...
                    rx.vstack(
                        ...
                        rx.hstack(
                            rx.button(
                                "🇰🇷 Korean",
                                variant=rx.cond(AudioState.has_ko_scenario,
                                    rx.cond(AudioState.gen_ko, "solid", "outline"),
                                    "outline"
                                ),
                                on_click=rx.cond(
                                    AudioState.has_ko_scenario,
                                    AudioState.set_gen_ko(~AudioState.gen_ko),
                                    rx.noop()
                                ),
                                opacity=rx.cond(AudioState.has_ko_scenario, 1, 0.5),
                                color_scheme=rx.cond(AudioState.has_ko_scenario,
                                    rx.cond(AudioState.gen_ko, "blue", "gray"),
                                    "gray"
                                ),
                            ...
                            rx.button(
                                "🇺🇸 English",
                                variant=rx.cond(AudioState.has_en_scenario,
                                    rx.cond(AudioState.gen_en, "solid", "outline"),
                                    "outline"
                                ),
                                on_click=rx.cond(
                                    AudioState.has_en_scenario,
                                    AudioState.set_gen_en(~AudioState.gen_en),
                                    rx.noop()
                                ),
                                opacity=rx.cond(AudioState.has_en_scenario, 1, 0.5),
                                color_scheme=rx.cond(AudioState.has_en_scenario,
                                    rx.cond(AudioState.gen_en, "blue", "gray"),
                                    "gray"
                                ),
                            ...
                            rx.button(
                                "🇯🇵 Japanese",
                                variant=rx.cond(AudioState.has_ja_scenario,
                                    rx.cond(AudioState.gen_ja, "solid", "outline"),
                                    "outline"
                                ),
                                on_click=rx.cond(
                                    AudioState.has_ja_scenario,
                                    AudioState.set_gen_ja(~AudioState.gen_ja),
                                    rx.noop()
                                ),
                                opacity=rx.cond(AudioState.has_ja_scenario, 1, 0.5),
                                color_scheme=rx.cond(AudioState.has_ja_scenario,
                                    rx.cond(AudioState.gen_ja, "blue", "gray"),
                                    "gray"
                                ),
                            ...
                            rx.scroll_area(
                                rx.vstack(
                                    rx.cond(
                                        ...
                                        rx.text(
                                            "Scenario file not available for Korean",
                                            color="gray",
                                            font_style="italic",
                                        ),
                                    ),
                            ...
                            rx.scroll_area(
                                rx.vstack(
                                    rx.cond(
                                        ...
                                        rx.text(
                                            "Scenario file not available for English",
                                            color="gray",
                                            font_style="italic",
                                        ),
                                    ),
                            ...
                            rx.scroll_area(
                                rx.vstack(
                                    rx.cond(
                                        ...
                                        rx.text(
                                            "Scenario file not available for Japanese",
                                            color="gray",
                                            font_style="italic",
                                        ),
                                    ),
